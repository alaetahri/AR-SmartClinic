...
<div class="container py-4">
    ...
    <div class="page-title d-flex justify-content-between align-items-center">
        <div>
            ...
            <p>Liste de tous les patients de la clinique</p>
        </div>
        <a href="{{ route('secretaire.patients.create') }}" class="btn btn-light fw-600">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('secretaire.patients.index') }}">
                <div class="row g-2">
                    <div class="col-md-10">
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @endif
                                    <div>
                                        <div class="fw-500">{{ $patient->user->prenom }} {{ $patient->user->nom }}</div>
                            ...
                            <td class="py-3">
                                @if($patient->sexe === 'homme')
                                    <span class="badge bg-info text-white"><i class="fas fa-mars me-1"></i>Homme</span>
                                @else
                                    <span class="badge bg-danger text-white"><i class="fas fa-venus me-1"></i>Femme</span>
                                @endif
                            </td>
                            <td class="py-3">
