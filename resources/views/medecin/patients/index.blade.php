...
<div class="container py-4">
    ...
    <div class="page-title">
        <h2><i class="fas fa-users me-2"></i> Mes Patients</h2>
        <p>Patients ayant consulté avec Dr. {{ session('user_prenom') }} {{ session('user_nom') }}</p>
    </div>

    {{-- RECHERCHE --}}
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('medecin.patients.index') }}">
                <div class="row g-2">
                    <div class="col-md-10">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3 text-center">
                                <a href="{{ route('medecin.patients.dossier', $patient->id) }}"
                                    class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-folder-medical me-1"></i>Dossier
                                </a>
                            </td>
                        </tr>
                        @empty
