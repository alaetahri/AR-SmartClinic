...
class ProfilController extends Controller
{
    public function index()
    {
        ...
        $medecin    = Medecin::with('specialite')->where('user_id', $user->id)->firstOrFail();
        $specialites = Specialite::all();
        return view('medecin.profil', compact('user', 'medecin', 'specialites'));
    }

    public function update(Request $request)
    {
        $user    = User::findOrFail(session('user_id'));
        $medecin = Medecin::where('user_id', $user->id)->firstOrFail();
        ...
        $medecin->update(['biographie' => $request->biographie]);
    ...
    public function updatePhoto(Request $request)
    {
        ...
        return redirect()->route('medecin.profil')->with('success', 'Photo mise à jour.');
    }
    ...
    public function supprimerPhoto()
    {
        ...
        return redirect()->route('medecin.profil')->with('success', 'Photo supprimée.');
    }
}